...
이 문제를 해결하기 위한 두 가지 방법을 제안한다. 하나는 이번 논문인 Neural Collaborative Filtering에서 사용한 방법이고, 다른 하나는 Collaborative Filtering for Implicit Feedback Datasets이라는 논문에서 사용한 방법이다.
